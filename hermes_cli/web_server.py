...
_BUILTIN_DASHBOARD_THEMES = [
    {"name": "default",       "label": "Coloss Teal",         "description": "Classic dark teal — the canonical Hermes look"},
    {"name": "default-large", "label": "Coloss Teal (Large)", "description": "Coloss Teal with bigger fonts and roomier spacing"},
