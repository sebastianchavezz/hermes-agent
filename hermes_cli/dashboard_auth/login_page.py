...
<body>
<main>
  <div class="brand">Seven<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Coloss dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Coloss</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
